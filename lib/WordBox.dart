...
class WordBox extends StatefulWidget {
  ...
  WordBox.fullEntry(this._letterCount, List<LetterEntry> entries) : _content = entries;
          ...
          return new Expanded(
              ...
              child: new Padding(
                ...
                child: new AspectRatio(
                  ...
                  new LetterBox(widget._content[index].color, widget._content[index].letter.toUpperCase(), fontsize: 50.0,) : new Placeholder(),
                ),
              ));
        })
    )
